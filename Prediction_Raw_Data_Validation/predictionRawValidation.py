    ...
    def deleteExistingGoodDataTrainingFolder(self):
        ...
        try:
            ...
            if os.path.isdir(path+"Good_Raw/"):
                ...
                file = open("Prediction_Logs/GeneralLog.txt", 'a+')
                self.logger.log(file, "Good_Raw directory  delted successfully !!!")
                file.close()
        except OSError as ex:
            file = open("Prediction_Logs/GeneralLog.txt", 'a+')
            self.logger.log(file, "Error while Deleting Good_Raw Directory %s:" % ex)
            file.close()
    ...
    def deleteExistingBadDataTrainingFolder(self):
        ...
        try:
            ...
            if os.path.isdir(path+"Bad_Raw/"):
                ...
                file = open("Prediction_Logs/GeneralLog.txt", 'a+')
                self.logger.log(file, "Bad_Raw directory  delted successfully !!!")
                file.close()
        except OSError as ex:
            file = open("Prediction_Logs/GeneralLog.txt", 'a+')
            self.logger.log(file, "Error while Deleting Bad_Raw Directory %s:" % ex)
            file.close()
            ...
            if os.path.isdir(source):
                ...
                for f in files:
                    if f not in os.listdir(dest):
                        shutil.move(source + f, dest)  #move each file to destination
                ...
                if re.match(regex,filename):
                    ...
                    if len(splitAtDot[2]) == LengthOfDateStampInFile:
                        if len(splitAtDot[3]) ==  LengthOfTimeStampInFile:
                            ...
                            self.logger.log(f, "Valid File Name !! File moved Good Raw folder :: %s" % filename)

                        else:
                            shutil.copy("Prediction_Batch_Files/"+filename,"Prediction_Raw_Files_validated/Bad_Raw")
                            self.logger.log(f, "Invalid File Name !! File moved Good Raw folder :: %s" % filename)
        ...
        try:
            ...
            for file in os.listdir('Prediction_Raw_Files_validated/Good_Raw/'):
                ...
                if csv.shape[1] == NumberofColumns:
                    ...
                    shutil.move("Prediction_Raw_Files_validated/Good_Raw/" + file,"Prediction_Raw_Files_validated/Bad_Raw/" + file )
                    self.logger.log(f, "Invalid column length!! File moved to Bad_Raw folder")
