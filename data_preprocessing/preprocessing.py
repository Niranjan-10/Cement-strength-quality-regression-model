...
class Preprocessor:
    ...
    def separate_label_feature(self, data, label_column_name):
        ...
        print(type(label_column_name))
        try:
            self.X = data.drop(labels=label_column_name, axis=1)
            print('hello')
            self.Y = data[str(label_column_name)]
            print('hello')
    ...
    def replaceInvalidValuesWithNull(self,data):
        """
            ...
            Description: Description: This method replaces invalid values i.e. '?' with null, as discussed in EDA.
    ...
    def is_null_present(self,data):
        ...
        try:
            ...
            # print(self.cols_with_missing_values)
            # print(self.null_present)
    ...
    def enccodedCategoricalValue(self,data):
        """
    ...
    def impute_missing_values(self, data):
        ...
        try:
            ...
            self.new_data = pd.DataFrame(data= self.new_array, columns= self.data.colummns)
